...
public class App2 {
    public static void main(String[] args) {
        ...
        List<List<OnlineClass>> event = new ArrayList<>();
        event.add(springClasses);
        event.add(javaClasses);
        ...
        System.out.println("\n10부터 1씩 증가하는 무제한 스트림 중에서 앞에 10개 빼고 최대 10개 가지만");
        Stream.iterate(10, i -> i + 1)
                .skip(10)
                .limit(10)
                .forEach(System.out::println);

        System.out.println("\n자바 수업 중에서 Test 가 들어 있는 수업이 있는지 확인");
